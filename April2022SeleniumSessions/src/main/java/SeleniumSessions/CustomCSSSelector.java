...
public class CustomCSSSelector {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.className("form-control private-form__control login-email")).sendKeys("naveen");//will not work 
		//driver.findElement(By.xpath("//input[@class='form-control private-form__control login-email']")).sendKeys("naveen");//will work 
		//driver.findElement(By.cssSelector(".form-control.private-form__control.login-email")).sendKeys("naveen");
		
		//htmltag[@prop='value']//xapth
		// htmltag[prop='value']//CSS selector
		
		// input[id='username']
		// input[id='username'][type='email']
		// input[id][type='email']
		// input[id][type][tabindex]
		///CSSs without id or class 
		// input[type='email']
		// input[name='username']
		
		// div.input-group input --> 3 ///Parent to all childs
		
		// div.input-group  input --> 2 ///Parent to direct child 
